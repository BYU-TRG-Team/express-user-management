        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (newAttributes.password !== undefined) {
                    newAttributes.password = yield bcrypt.hash(newAttributes.password, 10);
                }
                if (isClientUser
                ...
                if (newAttributes.username) {
                    ...
                    res.cookie(CookieConfig.cookieName, newToken, CookieConfig.generateCookieOptions(Date.now()));
                    res.send({ newToken });
                    return;
                }
                res.status(204).send();
