...
class AuthController {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                while (emailVerificationToken === undefined) {
                    ...
                    try {
                        yield this.db.objects.Token.create(newUser.user_id, shortToken, SessionTokenType.Verification, client);
    ...
    signin(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.cookie(CookieConfig.cookieName, token, CookieConfig.generateCookieOptions(Date.now()));
                res.json({ token });
            }
            catch (err) {
                this.logger.log({
    ...
    verify(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const verifyTokenResponse = yield this.db.objects.Token.findTokens(["token", "type"], [req.params.token, SessionTokenType.Verification]);
    ...
    */
    verifyRecovery(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const tokenResponse = yield this.db.objects.Token.findTokens(["token", "type"], [req.params.token, SessionTokenType.Password]);
    ...
    processRecovery(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                res.cookie(CookieConfig.cookieName, authToken, CookieConfig.generateCookieOptions(Date.now()));
    ...
    sendPasswordResetEmail(req, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (resetPasswordToken === undefined) {
                const shortToken = this.tokenHandler.generateShortToken();
                try {
                    yield this.db.objects.Token.create(user.user_id, shortToken, SessionTokenType.Password);
